                  ...
                  : (
                    <span>
                      <span className="d-lg-none">
                        ...
                        <Button className="float-right" color="link" size="sm" onClick={this.signOut}>
                        ...
                        <UncontrolledPopover className="d-none d-lg-block" trigger="legacy" placement="bottom" target="user-acconut-icon">
                          <PopoverBody>
                            <div className="text-center">
                              ...
                              <Button className="float-right" color="link" onClick={this.signOut}>
                                <i className="material-icons">exit_to_app</i>
                                <span>
                                  {' '}
              ...
              <NavItem>
                <UncontrolledDropdown inNavbar>
                  ...
                  <DropdownMenu right>
                    ...
                    <DropdownItem onClick={e => this.handleLanguageSwitch('ru-RU', e)}>
                      <T>navbar.russian</T>
                    </DropdownItem>
